...
(function() {
  ...
  CreateCertificateRequest = (function() {
    function CreateCertificateRequest(product, years, csr, dcvType) {
      ...
      this.approverEmail = '';
      this.approverPhone = '';
      this.approverRepresentativePosition = '';
      this.approverRepresentativeFirstName = '';
      this.approverRepresentativeLastName = '';
      this.approverRepresentativeEmail = '';
      this.approverRepresentativePhone = '';
      this.kvk = '';
      this.reference = '';
      this.language = '';
    }
